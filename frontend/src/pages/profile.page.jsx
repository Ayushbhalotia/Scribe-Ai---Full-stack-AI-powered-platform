...
// now we can say this id as profileid 
...
// yaha pe pehle destructure hoga and phir hi useeffect chalega toh yadi profileDataStructure nhi banate toh null se destructure karta jisse error hota toh isliye ye banaye hai yaha 
...
setLoading(true);
 ...
 return (
// ye profile datastrucutre isliye banaye empty karke kyuki jab render hoga ui toh request se pehle ye null rahega and ui me null se karenge toh error ayega islie empty bana liye jisse error na aaye and export kar diye yaha 
