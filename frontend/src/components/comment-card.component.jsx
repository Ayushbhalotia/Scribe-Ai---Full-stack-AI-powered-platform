...
<p className="font-galesio text-xl ml-3">{comment}</p>
...
<button className="underline " onClick={handleReplyClick}>Reply</button>
{
    ...
    <button onClick= {deleteComment}className="p-2 px-3 rouded-md border border-grey ml-auto hover:bg-red/30 hover:text-red flex items-center">
