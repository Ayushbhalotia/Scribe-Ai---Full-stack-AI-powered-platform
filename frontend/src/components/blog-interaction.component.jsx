...
<div className="flex gap-6 items-center">
    {
        ...
        // ye username jo logged in hai wo username hai and jiska ye blog hai uska username authorusername hai and usko nikale hai compare kiye yadi wahi jo logged in user hai wahi apna blog dekh rha hai toh user ko edit karne ka option milega yaha 
